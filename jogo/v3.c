...
#define MAX_tela_X 24  
#define MAX_tela_y 16
#define MAX_margem 15
...
#define monstro_3 'W'
#define monstro_4  'X'
#define MAX_monstro 20 // Máximo de monstros por linha
...
void tela() {
    ...
    printf("%*sPontos: %d", MAX_margem + 20, "", ponto);
    printf("%*snivel: %d", MAX_margem -10 , "", level);
    printf("%*svida: %d\n",15, "", vida);
